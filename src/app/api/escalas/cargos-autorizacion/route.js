...
export async function GET() {
  try {
    ...
    console.error("Error GET cargos-autorizacion:", error)
    return NextResponse.json({ error: "Error al obtener cargos de autorización" }, { status: 500 })
  }
}
...
export async function PUT(request) {
  try {
    ...
    console.error("Error PUT cargos-autorizacion:", error)
    return NextResponse.json({ error: "Error al reasignar el cargo de autorización" }, { status: 500 })
  }
}