...
// ============================================
export const GET = conPermiso("AERONAVES", "puede_ver", async (request, context, session) => {
...
// ============================================
export const POST = conPermiso("AERONAVES", "puede_crear", async (request, context, session) => {
